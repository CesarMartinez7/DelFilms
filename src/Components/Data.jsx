...
const Data = () => {
    ...
    return (
        <div>
            <h3 className="text-6xl font-semibold text-transparent bg-gradient-to-br mb-3.5 from-white to-gray-950 bg-clip-text text-center">Busca tus peliculas favoritas</h3>
            <form onSubmit={handleSubmit}>
                <label class="input input-bordered flex items-center gap-2 back">
                    <input type="text" class="grow" placeholder="Search" name='movie' />
                    <svg
