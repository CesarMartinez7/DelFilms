  ...
  return (
    <div className="stats shadow">
      <div className="stat">
        ...
        <div className="stat-value text-primary">{data?.original_language.toUpperCase()}</div>
      ...
      <div className="stat">
        ...
        <div className="stat-value text-secondary">{data?.release_date}</div>
        <div className="stat-desc">
      ...
      <div className="stat">
        ...
        <div className="stat-value">Critica</div>
        <div className="stat-title">{data?.vote_average}</div>
