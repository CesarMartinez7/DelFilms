    ...
    return (
        <div className="h-screen grid grid-cols-1 xl:grid-cols-2 xl:p-20 p-5" >
            <div className="flex flex-col items-center justify-center gap-2 text-center lg:text-left lg:items-start">
                <h1 className="text-6xl font-semibold text-transparent bg-gradient-to-br from-white to-gray-950 bg-clip-text">DelTi</h1>
            ...
            <div className="flex justify-center items-center">
                <img src={Rocket} alt="" width={"400px"} className="hover:backdrop toto"/>
            </div>
