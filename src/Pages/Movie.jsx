...
import MovieDetailLoading from "../Components/LoadingSkeleton";
...
const Movie = () => {
  const [id, URL, data, setData, opciones,handleAddToFavorites, isLoading] = MovieHook(); 

    return (
      
      <>

      {isLoading ? <MovieDetailLoading/> :  <section>
        <main>
          <MenuToolTip />
